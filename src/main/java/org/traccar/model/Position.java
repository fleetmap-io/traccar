...
public class Position extends Message {
    ...
    public static final String KEY_DP2 = "di2";
    public static final String KEY_DP2_TIME = "di2Time";
    ...
    public static final String ALARM_GEOFENCE_ABSENCE = "alarmGeofenceAbsence";
