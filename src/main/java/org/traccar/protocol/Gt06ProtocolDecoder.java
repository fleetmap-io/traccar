...
public class Gt06ProtocolDecoder extends BaseProtocolDecoder {
    ...
    private String decodeAlarm(int value, boolean modelLW, boolean modelSW, boolean modelVL) {
        switch (value) {
            ...
            case 0x09:
                return modelVL ? Position.ALARM_TOW : Position.ALARM_VIBRATION;
            case 0x0E:
            case 0x0F:
            ...
            case 0x28:
                return modelSW ? Position.ALARM_CORNERING : Position.ALARM_BRAKING;
            case 0x29:
                return modelSW ? Position.ALARM_ACCIDENT : Position.ALARM_ACCELERATION;
            case 0x2C:
                return Position.ALARM_ACCIDENT;
            case 0x30:
                return modelVL ? Position.ALARM_BRAKING : Position.ALARM_JAMMING;
            default:
                return null;
        }
    }
        ...
        if (type == MSG_LOGIN) {
            ...
            if (hasStatus(type, model)) {
                ...
                if (variant == Variant.OBD6) {
                    ...
                    position.set(Position.KEY_ALARM, decodeAlarm(buf.readUnsignedByte(), modelLW, modelSW, modelVL));
                    buf.readUnsignedByte(); // language
                    position.set(Position.KEY_BATTERY_LEVEL, buf.readUnsignedByte());
                    ...
                    if (type == MSG_STATUS && modelLW) {
                        ...
                        if (type == MSG_STATUS && modelSW) {
                            ...
                            position.set(Position.KEY_ALARM, decodeAlarm(extension, modelLW, modelSW, modelVL));
                        }
                    }
                }
            }
                ...
                while (buf.readableBytes() > 6) {
                    ...
                    switch (moduleType) {
                        case 0x0018:
                            ...
                            break;
                        case 0x0032:
                            position.set("startupStatus", buf.readUnsignedByte());
                            break;
                        case 0x006A:
                            position.set(Position.KEY_BATTERY_LEVEL, buf.readUnsignedByte());
                            break;
                ...
                if (values.length >= 2) {
                    switch (Integer.parseInt(values[0].substring(0, 2), 16)) {
                        case 40:
                            ...
                            break;
                        case 43:
                            position.set(Position.KEY_FUEL, Integer.parseInt(values[1], 16) * 0.01);
                            break;
                        case 45:
            ...
            while (buf.readableBytes() > 6) {
                ...
                switch (statusId) {
                    ...
                    case 0x000C:
                        ...
                        break;
                    default:
                        int statusLength2 = buf.readUnsignedByte();
                        buf.skipBytes(statusLength2 == 0 ? buf.readUnsignedByte() : statusLength2);
                        break;
                }
            }
